...
public class ParamChecks {
    ...
    /**
     * Throws an {@code IllegalArgumentException} if {@code value} is HORIZONTAL.
     * 
     * @param orientation  the orientation.
     * @param name  the parameter name (for use in the exception message).
     */
    public static void requireVerticalPlotOrientation(PlotOrientation orientation, String name) {
        if (orientation == PlotOrientation.HORIZONTAL) {
            throw new IllegalArgumentException("Require '" + name + "' to be VERTICAL.");
        }
    }
}
